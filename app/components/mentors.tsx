      ...
      <div className="px-10 flex flex-wrap justify-center md:justify-between gap-y-8">
        <div>
          <div className="relative">
            ...
            <img
              src="/static/mentor1.svg"
              alt="Mentor"
              className="absolute inset-0 m-auto w-[130px] h-[130px] md:w-[170px] md:h-[170px]"
            />
          </div>
